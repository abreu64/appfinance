                    ...
                    <div className="flex flex-col items-center mb-12">
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <span className="h-[1px] w-8 bg-gradient-to-r from-transparent to-zinc-500/50"></span>
                                <span className="text-[11px] font-black uppercase tracking-[0.6em] text-emerald-500/70 group-hover:text-emerald-400 transition-colors">
                                    um produto
                                </span>
                                <span className="h-[1px] w-8 bg-gradient-to-l from-transparent to-zinc-500/50"></span>
                            </div>
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    ...
                    >
                        ...
                        <button
                            ...
                            className={`absolute bottom-6 right-6 md:bottom-10 md:right-10 z-20 p-4 rounded-full glass-morphism border border-white/10 text-white hover:bg-emerald-500 hover:text-zinc-950 transition-all active:scale-90 shadow-2xl group/audio ${isMuted ? 'animate-pulse' : ''} cursor-pointer`}
                        >
                            {isMuted ? (
