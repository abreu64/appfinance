...
export const MobileCarousel: React.FC = () => {
  ...
  return (
    <section
      className="relative w-full py-32 bg-zinc-900 border-t border-white/5"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <span className="text-amber-500 font-bold tracking-[0.4em] uppercase text-[10px] mb-4 block">Experiência Mobile</span>
        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="mt-16 text-center max-w-lg min-h-[120px]">
            <div className="overflow-hidden h-10 mb-2">
              {MOBILE_SCREENSHOTS.map((screen, index) => (
                <h3
                  key={index}
                  className={`text-2xl md:text-3xl font-black text-white tracking-tight uppercase transition-all duration-500 ${index === currentIndex ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                    }`}
          ...
          <div className="flex justify-center gap-3 mt-10">
            {MOBILE_SCREENSHOTS.map((_, i) => (
              ...
              >
                <div className={`h-full transition-all duration-500 rounded-full bg-zinc-900 ${i === currentIndex ? 'w-16' : 'w-3'
                  }`}>
                  {i === currentIndex && (
                    <div
